 ...
 * @author javcoder
 */
public class ImportClientEnd extends javax.swing.JFrame {

    private int code;

    public ImportClientEnd(int cod) {
        this.code = cod;
        initComponents();
        this.setLocationRelativeTo(null);
        retrieveDataFromImportEndingTable(code);
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        this.dispose();
        EndingClinets f = new EndingClinets();
        f.setVisible(true);
    }//GEN-LAST:event_backBtnActionPerformed

    private void retrieveDataFromImportEndingTable(int code) {
        Connection conn = null;
        Statement st = null;
        ResultSet rs = null;
        ResultSetMetaData rsm = null;
        String query = "SELECT * FROM importdetails WHERE Code = '" + code + "' ";
        ...
        try {
            ...
            Logger.getLogger(ImportClientEnd.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                if (conn != null) {
                    conn.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImportClientEnd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImportClientEnd(1).setVisible(true);
            }
        });
    }
