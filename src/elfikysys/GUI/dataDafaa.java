 ...
 * @author javcoder
 */
public class dataDafaa extends javax.swing.JFrame {
    ...
    public dataDafaa(int cod, String nam, String addres, String phon, int total, int emdf, int tipss, int payday, int paymonth) {
        this.code = cod;
        this.name = nam;
        this.address = addres;
        this.phone = phon;
        ...
        putData(code, name, address, phone, totalprice, elmadfoaa, tips, paydays, paymonths);
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        PaymentTimes list = new PaymentTimes();
    ...
    private void putData(int code, String name, String address, String phone, int totalprice, int elmadfoaa, int tips, int paydays, int paymonths) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataDafaa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dataDafaa(1, "dfdf", "dfd", "dfdfdf", 11, 11, 33, 11, 11).setVisible(true);
            }
        });
    }
