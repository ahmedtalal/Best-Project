 ...
 * @author javcoder
 */
public class PaymentTimes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "شهر الدفع", "يوم الدفع", "الباقي", "المدفوع", "الاجمالي", "رقم الفون", "العنوان", "الاسم", "الكود"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.String.class, java.lang.Double.class, java.lang.String.class, java.lang.Integer.class
            };
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int code, totalprice, emdfoaa, tips, payday, paymonth;
        if (seletedRow == -1) {
            ...
            payday = Integer.parseInt(model.getValueAt(seletedRow, 7).toString());
            paymonth =Integer.parseInt(model.getValueAt(seletedRow, 8).toString());

            dataDafaa d = new dataDafaa(code, name, address, phone, totalprice, emdfoaa, tips, payday, paymonth);
            d.setVisible(true);
            this.dispose();
        }
...
//        }
    ...
    void filter(String se) {
        ...
        tr.setRowFilter(RowFilter.regexFilter(se,1,8));
    }
    ...
    private void retireveDataFromDB() {
        ...
        String query = "SELECT Code, Name, Address, Phone, Totalprice ,Elmadfoaa, Teps, DayDafaa, MonthDafaa  FROM contracts ";
    ...
    private void retrieveSpecialFromDB(int result) {
        ...
        ResultSet rs = null;
        ResultSetMetaData rsm = null;
        String query = "SELECT Code, Name, Address, Phone, Totalprice ,Elmadfoaa, Teps, DayDafaa, MonthDafaa  FROM contracts WHERE MonthDafaa = '" + result + "' ";
        columnsnName.add("الكود");
        columnsnName.add("الاسم");
        columnsnName.add("العنوان");
        columnsnName.add("رقم الفون");
...
//                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentTimes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentTimes().setVisible(true);
            }
        });
    }
